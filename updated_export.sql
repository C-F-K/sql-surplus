 ...
 /* This is so we don't include Univeristy of Liverpool's test modules */
  ...
  SELECT bb_bb60.COURSE_MAIN.COURSE_ID AS CourseID, ',opt1/archived_modules'
   ...
   WHERE bb_bb60.COURSE_MAIN.COURSE_NAME != 'Personal Test Module'
	 ...
	 AND ((bb_bb60.COURSE_MAIN.DTMODIFIED > TO_DATE('27/07/2004', 'DD/MM/YY') AND bb_bb60.COURSE_MAIN.DTMODIFIED IS NOT NULL)
      OR (bb_bb60.COURSE_CONTENTS.DTMODIFIED > TO_DATE('27/07/2004', 'DD/MM/YY') AND bb_bb60.COURSE_CONTENTS.DTMODIFIED IS NOT NULL)
	  OR (bb_bb60.CONFERENCE_MAIN.DTMODIFIED > TO_DATE('27/07/2004', 'DD/MM/YY') AND bb_bb60.CONFERENCE_MAIN.DTMODIFIED IS NOT NULL)
	  OR (bb_bb60.CALENDAR.DTMODIFIED > TO_DATE('27/07/2004', 'DD/MM/YY') AND bb_bb60.CALENDAR.DTMODIFIED IS NOT NULL)
      OR (bb_bb60.QTI_ASI_DATA.BBMD_DATE_MODIFIED > TO_DATE('27/07/2004', 'DD/MM/YY') AND bb_bb60.QTI_ASI_DATA.BBMD_DATE_MODIFIED IS NOT NULL)
	  OR (bb_bb60.GRADEBOOK_MAIN.DATE_MODIFIED > TO_DATE('27/07/2004', 'DD/MM/YY') AND bb_bb60.GRADEBOOK_MAIN.DATE_MODIFIED IS NOT NULL)
	  OR (bb_bb60.ANNOUNCEMENTS.START_DATE > TO_DATE('27/07/2004', 'DD/MM/YY') AND bb_bb60.ANNOUNCEMENTS.START_DATE IS NOT NULL))
